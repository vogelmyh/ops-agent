# Ops 面试作品 — Git Monorepo

运维诊断 Agent 全链路：**Python Agent** + **Simulator** + **Java 后端** + **部署清单**。
...
华为云经历复刻（Java/Go）位于上级 `project-for-interview/`，各自独立 Git 仓库，见该目录 [`README.md`](../README.md)。
