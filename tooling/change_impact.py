...
RULES: list[tuple[str, list[str], list[str]]] = [
    ...
    ("agent/scripts/run_demo.py", ["docs/agent/demo-scenarios.md", "docs/agent/demo-presenter.md"], ["test-graph"]),
    ("agent/scripts/demo_presenter/", ["docs/agent/demo-presenter.md"], ["test-graph"]),
    ("agent/scripts/scenario_runtime.py", ["docs/agent/demo-presenter.md", "docs/agent/backend-adapters-architecture.md"], ["test-graph"]),
    ("agent/tests/test_runner_stream.py", ["docs/agent/demo-presenter.md", "docs/agent/graph-agent-architecture.md"], ["test-graph"]),
    ("agent/tests/test_demo_presenter.py", ["docs/agent/demo-presenter.md"], ["test-graph"]),
