...
def verify_remediation_node(state: AgentState) -> dict:
    ...
    if settings.llm_is_mock:
        ...
        assessment = invoke_structured(
            ...
            [
                SystemMessage(content=REMEDIATION_VERIFY_SYSTEM_PROMPT),
    ...
    return {
        ...
        "remediation_verify_reasoning": assessment.reasoning,
...
# Deprecated alias
eval_remediation_node = verify_remediation_node
REMEDIATION_EVAL_SYSTEM_PROMPT = REMEDIATION_VERIFY_SYSTEM_PROMPT
